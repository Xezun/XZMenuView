...
@interface CustomViewController () <UIPageViewControllerDelegate, UIPageViewControllerDataSource, XZMenuViewDelegate, XZMenuViewDataSource>
...
- (UIView *)menuView:(XZMenuView *)menuView viewForItemAtIndex:(NSInteger)index reusingView:(__kindof UIView *)reusingView {
    MenuItemView *menuItemView = (MenuItemView *)reusingView;
    if (menuItemView == nil) {
        menuItemView = [[MenuItemView alloc] initWithTransitionOptions:XZPlainMenuItemViewTransitionOptionScale | XZPlainMenuItemViewTransitionOptionColor];
    ...
    menuItemView.title = [menuItem substringToIndex:1];
    menuItemView.subtitle = [menuItem substringFromIndex:MAX(menuItem.length - 2, 0)];
